...
boton_show_info = tk.Button (main_window, text='messagebox.showinfo', command=show_info)
boton_ask_question = tk.Button (main_window, text='messagebox.askquestion', command=ask_question)
